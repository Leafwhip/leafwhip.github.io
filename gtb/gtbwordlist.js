let wordlist = [
    ...
    'apple tree,beach ball,black hole,board game,candy cane,clown fish,disco ball,genie lamp,magic wand,magma cube,onion ring,phone case,piggy bank,polar bear,teddy bear,theme park,totem pole,towel rack,trick shot,water park',
